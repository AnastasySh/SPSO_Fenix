...
<head>
    ...
    <title>Вступление в отряд</title>
...
<div class="footer-wrap">
    ...
    <div class="footer-contact-wrap">
        ...
        <span class="div-line">
            ...
            <a href="#" target="_blank" class="cta-btn-form manual-link"><span>Записаться в Отряд</span> <span class="icon-ArrowRight"></span></a>
        </div>
    </div>
    <span class="icon-ArrowUp"></span></div>
...
<div class="ajax-wrap">
    <!--Видео-->
    <div id="hero-bg-vid" data-vide-bg="mp4: VS.mp4, poster:home-bg.jpg " data-vide-options="bgColor: #000000, loop: true, muted: true, position: 50% 50%, posterType: jpg">
        <div style="position: absolute; z-index: 1; top: 0px; left: 0px; bottom: 0px; right: 0px; overflow: hidden; background-size: cover; background-color: rgb(0, 0, 0); background-repeat: no-repeat; background-position: 50% 50%; background-image: none;">
    ...
    <div class="work-intro">
        <div class="video-bg-section rollin top" data-vide-bg="mp4: VS.mp4, home-bg.jpg " data-vide-options="bgColor: #000000, loop: true, muted: true, position: 50% 50%, posterType: jpg">
            <div style="position: absolute; z-index: 1; top: 0px; left: 0px; bottom: 0px; right: 0px; overflow: hidden; background-size: cover; background-color: rgb(0, 0, 0); background-repeat: no-repeat; background-position: 50% 50%; background-image: none;">
    ...
    <main class="content">
        ...
        <section class="services-list delife last">
            <header class="m-all t-all d-all cf rollin now">
                <div class="sub-title">
                    <p>Вдохновляющий текст</p>
                </div>
