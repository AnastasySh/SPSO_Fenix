...
<body class="page-template page-template-page-contact page-template-page-contact-php page page-id-2 scrolltop">
<!--Лого верх-->
<div class="icon-logo">
...
<section class="project-intro">
    <div class="m-all t-1of2 d-1of2 cf intro-copy-wrap">
        <div class="intro-copy">
            <div class="intro-copy-inner">
                <div class="m-1of4 t-3of7 d-3of7 cf intro-title">
                    <p class="category-title">Иди к нам</p>
                    <h2>Наши<br>Контакты</h2>
                </div>
                <div class="m-3of4 t-4of7 d-4of7 cf intro-body-copy">
                    <p>Чем мы можем тебе помочь?</p>
                    <div class="div-line-wrap">
                        <span class="div-line"></span>
                    </div>
                    <p><strong>Email</strong>
<a href="mailto:spso_fenix@gmail.com" onclick="ga(&#39;send&#39;, &#39;event&#39;, &#39;contact&#39;, &#39;email&#39;, &#39;contact&#39;);">spso_fenix@gmail.com</a></p>
...
<br><br></p>
                    ...
                    <br>МОСКОВСКИЙ ПОЛИТЕХНИЧЕСКИЙ УНИВЕРСИТЕТ<br>
                    ст. м. «Электрозаводская»<br>
                    ул. Большая Семеновская, 38 Кабинет: А 405<br>
<a href="" target="_blank">На Карте</a></p>
                    <div class="social-icons"><p><strong>Мы в соц. сети</strong><br>
<a href="#" target="_blank">Instagram</a><br>
<a href="#" target="_blank">VK</a><br>
