...
<head>
    ...
    <title>Структура и Руководство</title>
    ...
    <div class="m-1of4 t-3of7 d-3of7 cf intro-title">
        ...
        <h2>Структура</h2></div>
            <div class="m-3of4 t-4of7 d-4of7 cf intro-body-copy">
                <h4 class="overview-title">Структура Всероссийского студенческого корпуса спасателей.</h4>
                <img class="m-all t-all" style="padding-bottom: 15px" src="./img/structure.png" alt="структура наглядно">
                <p>
                    СПСО Феникс относится к категории "студенческие спасательные отряды ВУЗов, ССУЗов".</p>
                </div>
        </div>
    </div>
    </div>
    </section>
<section class="services-list delife">
<header class="m-all t-all d-all cf rollin now">
    <h2>
        ...
        <br>
        Начальник отдела: <br>
        Офицеров Сергей Альбертович <br>
        Тел.: +7 (495) 223-05-23 доб. 1033 <br>
        <hr>
        Заместитель: <br>
        Загладин Владислав Геннадьевич <br>
        Тел.: +7 (495) 223-05-23 доб. 3050 <br>
    </h2>
   </header>
</section>
